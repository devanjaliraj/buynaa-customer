  ...
  useEffect(() => {
    async function getData() {
      const response = await fetch(
        "http://35.154.86.59/api/admin/getproductbytagname/Women"
      );
...
export default connect(mapStateToProps)(ShopGridWomenColumn);

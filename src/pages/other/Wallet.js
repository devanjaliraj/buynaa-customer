                      ...
                      <Card.Body>
                        <Form onSubmit={this.submitHandler}>
                          ...
                          <div className=''style={{marginTop:'20px'}}>
                            <Label>Add Money to Agricoin Wallet</Label>
                            {/* <span></span> */}
                          </div>
                          <div className="row">
                            {/* <div className="col-lg-6 col-md-6">
                            ...
                            <div className="col-lg-6 col-md-6">
                              <Button name="subject" style={{backgroundColor:'#34b56b'}}>Deposite</Button>
                              </div>
                              <div className="col-lg-6 col-md-6">
                              <Button name="subject" style={{backgroundColor:'#34b56b'}}>Withdrow</Button>
                            </div>
                          </div>
                          {/* <div className="">

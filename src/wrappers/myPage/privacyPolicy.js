      ...
      <LayoutOne>
        <Container fluid>
          <Row className="mb-5">
            ...
            >
              <div className="">
                <h1 className="text-light text-center">PrivacyPolicy</h1>
              </div>
            </div>
          </Row>
          <Container>
            ...
            <Row>
              <ListGroup>
                ...
                the Internet. ● Personnel: refers to those individuals who are
                employed by WonderLite or are under contract to perform a
                service on behalf of one of the parties. ● Personal Data: any
                ...
                person. ● Service: refers to the service provided by WonderLite
                ...
                interest you. ● Website: site, which can be accessed via this
                URL: ● You: a person or entity that is registered with
